...
//            JSONArray earchquakeArray = baseJsonResponse.getJSONArray("features");
//
//            for (int i = 0; i < earchquakeArray.length(); i++){
//                JSONObject currentEarthquake = earchquakeArray.getJSONObject(i);
